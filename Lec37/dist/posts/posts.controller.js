...
__decorate([
    ...
    __param(1, (0, user_decorators_1.User)('sub')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns all posts' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns post by ID' }),
